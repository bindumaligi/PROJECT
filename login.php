...
<?php
// need to protect the login page
// if the user is logged in, we need to take them to home page and we should n't leave them in login page
//---->>> This code will check if the user is logged in or not

session_start();
// id is the perfecte parameter to check if the user is logged in or not

//if user_id in session, then user is logged in
